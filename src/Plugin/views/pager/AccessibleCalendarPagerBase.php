...
use Drupal\accessible_calendar\Plugin\views\style\AccessibleCalendarInterface;
...
/**
 * Defines a common class for Accessible Calendar style plugins.
 */
abstract class AccessibleCalendarPagerBase extends BasePager implements AccessibleCalendarPagerInterface {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $example_timestamp = strtotime('2023-12-25 00:00:00');
    ...
    $form['label_format'] = [
      ...
      '- <code>l, F dS Y</code>' . ' ' . $this->t('results in @output', [
        '@output' => $date_formatter->format($example_timestamp, 'custom', 'l, F dS Y'),
      ]),
  ...
  public function getCalendarTimestamp(): int {
    ...
    if (!$style instanceof AccessibleCalendarInterface) {
      return date('U');
    }
