 ...
 * )
 */
class AccessibleCalendarMonth extends AccessibleCalendarBase {
  ...
  public function buildTable($year, $month) {
    ...
    $build = [
      ...
      '#empty' => NULL,
      '#attributes' => [
        'data-accessible-calendar-year' => $year,
        'data-accessible-calendar-month' => $month,
        'class' => [
          'accessible-calendar-table',
          'accessible-calendar-view-month',
        ],
      ],
    ];
